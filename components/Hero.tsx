...
export default function Hero() {
  return (
    <section
      id="top"
      className="relative overflow-hidden bg-navy-dark pt-16 pb-24 sm:pt-20 sm:pb-32"
    >
      <div
      ...
      />
      <div
        className="animate-float pointer-events-none absolute -top-40 -right-40 h-96 w-96 rounded-full bg-gold/10 blur-3xl"
        aria-hidden="true"
      />
      <div
        className="animate-float-reverse pointer-events-none absolute -bottom-32 -left-32 h-80 w-80 rounded-full bg-navy/40 blur-3xl"
        aria-hidden="true"
      />
      ...
      <Container className="relative grid items-center gap-16 lg:grid-cols-2 lg:gap-12">
        <div>
          ...
          <Reveal delay={0.08}>
            <h1 className="mt-6 font-display text-4xl font-bold leading-[1.05] tracking-tight text-offwhite sm:text-5xl lg:text-6xl">
          ...
          <Reveal delay={0.16}>
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-slate-200/80">
        ...
        <Reveal delay={0.15} className="relative mx-auto w-full max-w-md">
          ...
          <div className="absolute -bottom-8 -left-6 w-64 rounded-sm border border-gold/30 bg-navy/95 p-5 shadow-2xl shadow-black/40 backdrop-blur sm:-left-10">
            ...
            <ul className="mt-3 space-y-1.5 text-sm text-offwhite/75">
